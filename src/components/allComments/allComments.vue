      ...
      <div class="page-tab-container">
        <mt-tab-container class="page-tabbar-tab-container" v-model="active" >
          <mt-tab-container-item id="tab-container1">
            <!-- cell组件 -->
            <div class="none">-暂时还没有评论-</div>
            <div class="page-tab-container-center" v-for="item in data2">

              <div class="center-top"><img :src="item.storeIcon" alt="" width="40" height="40"></div>

              <div class="center-center">
                <div class="center-mid">
                  <div class="mid-top"><span>{{item.goodsName}}({{item.storeName}})</span></div>
  ...
  export default {
    ...
    methods:{
      ...
      colorB:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/comment?i=2').then(resp =>{
          let data = resp.data;
      ...
      colorC:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/comment?i=3').then(resp =>{
          let data = resp.data;
      ...
      colorD:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/comment?i=4').then(resp =>{
          let data = resp.data;
    ...
    _initData: function () {
      axios.get('http://39.108.161.47:8080/rener/comment?i=1').then(resp =>{
        let data = resp.data;
