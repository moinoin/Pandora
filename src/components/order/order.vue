  ...
  export default {
    ...
    methods:{
      check: function(message,t){
        ...
        if(message == 0){
          this.mess=0;
          axios.get("http://39.108.161.47:8080/order/getOrder?status=1").then(res => {
          ...
          this.mess=1;
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=2").then(res => {
            if(res.data.msg.items.length==0){
              document.getElementsByClassName('footer')[0].style.display="none";
            }else{
              document.getElementsByClassName('footer')[0].style.display="block"
          ...
          this.mess=2;
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=3").then(res => {
            if(res.data.msg.items.length==0){
              document.getElementsByClassName('footer')[0].style.display="none";
            }else{
              document.getElementsByClassName('footer')[0].style.display="block"
          ...
          this.mess=3;
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=5").then(res => {
            if(res.data.msg.items.length==0){
              document.getElementsByClassName('footer')[0].style.display="none";
            }else{
              document.getElementsByClassName('footer')[0].style.display="block"
          ...
          this.mess=5;
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=4").then(res => {
            if(res.data.msg.items.length==0){
              document.getElementsByClassName('footer')[0].style.display="none";
            }else{
              document.getElementsByClassName('footer')[0].style.display="block"
          ...
          this.mess=6;
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=6").then(res => {
            if(res.data.msg.items.length==0){
              document.getElementsByClassName('footer')[0].style.display="none";
            }else{
              document.getElementsByClassName('footer')[0].style.display="block"
      ...
      toorderDetails :function (item,index){
        if(this.mess == 0){
          axios.get("http://39.108.161.47:8080/rener/order/getOrder?status=1").then(res => {
