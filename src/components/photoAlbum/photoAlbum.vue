    ...
    <div class="center">
      <div class="photo-top" v-for="item in data2">
        ...
        <div class="photo-top-center">
          <img :src="item" alt="" v-for="item in item.photoUrl " width="110" height="110" class="photo-top-center-img">
...
<script>
  ...
  export default {
    ...
    methods: {
        _initData: function () {
          axios.get('http://39.108.161.47:8080/rener/photo/allMonth?id=1').then( resp=>{
            let data=resp.data;
