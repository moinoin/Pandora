<template>
  <div class="search" onLoad="checkCookie()">
    ...
    <div class="search-hot">
      ...
      <div class="hot-good">
        <div class="good" v-for="(item,index) in searchHot">
...
//      toHot:function (index) {
//        console.log(this.searchHot[index].goodsType);
//        this.$router.push({
//          path:'/goodlist',
//          query:{
//            type:this.searchHot[index].goodsType
//          }
//        });
//      },
      sea:function () {
      ...
      unClearSearch:function () {
        let value=document.getElementById("put").value;
        axios.get('http://39.108.161.47:8080/rener/fuzzySelectType/selectType',{
          params:{
            types:value
          }
        }).then(res => {
      ...
      _initSearchListData:function(){
        axios.get('http://39.108.161.47:8080/rener/fuzzySelectType/goodsHeatType').then(res => {
          console.log(res.data);
