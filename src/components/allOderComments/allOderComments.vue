  ...
  export default {
    ...
    methods:{
      ...
      colorB:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/rener/comment?i=2').then(resp =>{
          let data = resp.data;
      ...
      colorC:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/rener/comment?i=3').then(resp =>{
          let data = resp.data;
      ...
      colorD:function (i) {
        ...
        document.getElementsByClassName('nav-center')[i].style.backgroundColor='#ccc';
        axios.get('http://39.108.161.47:8080/rener/comment?i=4').then(resp =>{
          let data = resp.data;
