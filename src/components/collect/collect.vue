...
<script>
  ...
  export default {
    ...
    methods:{
      _initOrderListData () {
        const goodStore =  'http://39.108.161.47:8080/rener/colles/list.do';
      ...
      choosePlace:function(){
        const allPlace =  ' http://39.108.161.47:8080/rener/colles/selectAreaString';
        if(bPlace){
      ...
      chooseKind:function(){
        const allKind =  'http://39.108.161.47:8080/rener/colles/selectClassString';
        if(bKind){
      ...
      choosePlace1: function(place){
        ...
        this.text2 = "按类别";
        this.text3 = "按时间";
        axios.get("http://39.108.161.47:8080/rener/colles/selectStoresByArea.do?",{
          params:{
            area: this.text1
          }
        }).then(res => {
      ...
      chooseKind1: function(kind){
        ...
        this.text3 = "按时间";
        axios.get("http://39.108.161.47:8080/rener/colles/selectStoresByClasses?",{
          params:{
            classes: this.text2
          }
        }).then(res => {
      ...
      chooseTime1 :function(){
        ...
        this.text2 = "按类别";
        this.text3 = "近三天";
        axios.get("http://39.108.161.47:8080/rener/colles/selectStoresByDates?dateType=threeDays").then(res => {
          let data = res.data;
          this.dataAll = Object.assign({},data);
        }).catch(err => {
          console.log(err);
      ...
      chooseTime2:function(){
        ...
        this.text2 = "按类别";
        this.text3 = "近一周";
        axios.get("http://39.108.161.47:8080/rener/colles/selectStoresByDates?dateType=oneWeek").then(res => {
          let data = res.data;
          this.dataAll = Object.assign({},data);
        }).catch(err => {
          console.log(err);
      ...
      chooseTime3:function(){
        ...
        this.text2 = "按类别";
        this.text3 = "近一月";
        axios.get("http://39.108.161.47:8080/rener/colles/selectStoresByDates?dateType=oneMonth").then(res => {
          let data = res.data;
          this.dataAll = Object.assign({},data);
        }).catch(err => {
          console.log(err);
